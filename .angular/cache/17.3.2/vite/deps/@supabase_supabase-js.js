...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => import("./browser-YU6FVV6W.js").then(({ default: fetch2 }) => fetch2(...args));
  } else {
    _fetch = fetch;
  }
...
var RealtimeClient = class {
  ...
  connect() {
    ...
    import("./browser-GYPLSDI5.js").then(({ default: WS }) => {
...
var resolveResponse = () => __awaiter2(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-YU6FVV6W.js")).Response;
  }
  return Response;
});
...
function _handleRequest2(fetcher, method, url, options, parameters, body) {
  return __async(this, null, function* () {
    ...
    let result;
    try {
      result = yield fetcher(url, Object.assign(Object.assign({}, requestParams), {
