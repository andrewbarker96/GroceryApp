...
var require_main = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports, module) {
    ...
    function _vaultPath(options) {
      let dotenvPath = import_path.default.resolve(process.cwd(), ".env");
    ...
    function _resolveHome(envPath) {
      return envPath[0] === "~" ? import_path.default.join(import_os.default.homedir(), envPath.slice(1)) : envPath;
    }
    ...
    function configDotenv(options) {
      ...
      try {
        const parsed = DotenvModule.parse(import_fs.default.readFileSync(dotenvPath, { encoding }));
        let processEnv = process.env;
        if (options && options.processEnv != null) {
          processEnv = options.processEnv;
        }
    ...
    function decrypt(encrypted, keyStr) {
      ...
      try {
        const aesgcm = import_crypto.default.createDecipheriv("aes-256-gcm", key, nonce);
