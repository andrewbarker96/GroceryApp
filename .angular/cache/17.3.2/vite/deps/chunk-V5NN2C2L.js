...
// node_modules/@ionic/core/dist/esm-es5/index-73fa3fe8.js
var NAMESPACE = "ionic";
...
var clientHydrate = function(e, t, r, n, a, i, o) {
  ...
  if (i.nodeType === 1) {
    ...
    if (l) {
      s = l.split(".");
      if (s[0] === o || s[0] === "0") {
        u = { p: 0, C: s[0], _: s[1], R: s[2], $: s[3], m: i.tagName.toLowerCase(), h: i, o: null, l: null, u: null, v: null, i: null };
        t.push(u);
    ...
    if (s[1] === o || s[1] === "0") {
      l = s[0];
      u = { p: 0, C: s[1], _: s[2], R: s[3], $: s[4], h: i, o: null, l: null, u: null, v: null, m: null, i: null };
      if (l === TEXT_NODE_ID) {
        u.h = i.nextSibling;
    ...
    if (typeof i === "string") {
      ...
      if (!o.has(a)) {
        if (e.host && (l = e.querySelector("[".concat(HYDRATED_STYLE_ID, '="').concat(a, '"]')))) {
          ...
          l.innerHTML = i;
          var s = (n = plt.N) !== null && n !== void 0 ? n : queryNonceMetaTagContent(doc2);
          if (s != null) {
...
var renderVdom = function(e, t, r) {
  ...
  patch(u, f, r);
  {
    ...
    if (checkSlotRelocate) {
      ...
      for (var T = 0, C = relocateNodes; T < C.length; T++) {
        var y = C[T];
        var S = y.I;
        var _ = y.H;
        if (_) {
          ...
          S && typeof _["s-rf"] === "function" && _["s-rf"](S);
        } else {
          if (S.nodeType === 1) {
            if (r) {
...
var bootstrapLazy = function(e, t) {
  ...
  e.map(function(e2) {
    e2[1].map(function(t2) {
      var r2;
      var n2 = { p: t2[0], L: t2[1], B: t2[2], X: t2[3] };
      if (n2.p & 4) {
        m = true;
      }
      {
...
// node_modules/@ionic/core/dist/esm-es5/index-4feaf001.js
...
@ionic/core/dist/esm-es5/index-73fa3fe8.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
...
@ionic/core/dist/esm-es5/index-4feaf001.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=chunk-V5NN2C2L.js.map
